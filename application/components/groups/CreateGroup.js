...
import { globals, autocompleteStyles } from '../../styles';
...
class CreateGroup extends Component {
    ...
    handlePress(data, details) {
        ...
        let location = {
            ...
            country: find(details.address_components, (c) => c.types[0] === 'administrative_area_level_2'),
            ...
            <View style={[globals.flexContainer, globals.inactive]}>
                ...
                >
                    ...
                    <TextInput
                        ...
                        multiline={true}
                        placeholder="Type a message to people interested in your group..."
                    />
                </KeyboardAwareScrollView>
                <TouchableOpacity
